...
generate-e2e-templates: $(KUSTOMIZE)
	...
	$(KUSTOMIZE) build $(OCI_TEMPLATES)/v1beta2/cluster-template-vnic-hostname-dns --load-restrictor LoadRestrictionsNone > $(OCI_TEMPLATES)/v1beta2/cluster-template-vnic-hostname-dns.yaml
