...
type VCN struct {
	...
	// +optional
	NetworkSecurityGroupManagement NetworkSecurityGroupManagement `json:"networkSecurityGroupManagement,omitempty"`
}
...
// NetworkSecurityGroupManagement is used to specify the options for managing network security groups.
type NetworkSecurityGroupManagement struct {
