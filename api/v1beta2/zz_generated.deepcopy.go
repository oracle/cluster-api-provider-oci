...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkSecurityGroups) DeepCopyInto(out *NetworkSecurityGroups) {
	*out = *in
	if in.NSGList != nil {
		in, out := &in.NSGList, &out.NSGList
		*out = make([]*NSG, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkSecurityGroups.
func (in *NetworkSecurityGroups) DeepCopy() *NetworkSecurityGroups {
	if in == nil {
		return nil
	}
	out := new(NetworkSecurityGroups)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VCN) DeepCopyInto(out *VCN) {
	*out = *in
	...
	in.NetworkSecurityGroups.DeepCopyInto(&out.NetworkSecurityGroups)
}
