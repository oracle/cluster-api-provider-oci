...
func (c *OCIManagedCluster) Default() {
	...
	if !c.Spec.NetworkSpec.SkipNetworkManagement {
		if len(c.Spec.NetworkSpec.Vcn.Subnets) == 0 {
			subnets := make([]*infrastructurev1beta1.Subnet, 4)
			subnets[0] = &infrastructurev1beta1.Subnet{
			...
			subnets[1] = &infrastructurev1beta1.Subnet{
			...
			subnets[2] = &infrastructurev1beta1.Subnet{
			...
			subnets[3] = &infrastructurev1beta1.Subnet{
		...
		if c.Spec.NetworkSpec.Vcn.CIDR == "" {
			c.Spec.NetworkSpec.Vcn.CIDR = infrastructurev1beta1.VcnDefaultCidr
		}
	}
}
...
func (c *OCIManagedCluster) validate(old *OCIManagedCluster) field.ErrorList {
	...
	var oldNetworkSpec infrastructurev1beta1.NetworkSpec
	if old != nil {
		oldNetworkSpec = old.Spec.NetworkSpec
	}

	allErrs = append(allErrs, infrastructurev1beta1.ValidateNetworkSpec(infrastructurev1beta1.OCIManagedClusterSubnetRoles, c.Spec.NetworkSpec, oldNetworkSpec, field.NewPath("spec").Child("networkSpec"))...)
	allErrs = append(allErrs, infrastructurev1beta1.ValidateClusterName(c.Name)...)
	...
	if len(c.Spec.CompartmentId) > 0 && !infrastructurev1beta1.ValidOcid(c.Spec.CompartmentId) {
		allErrs = append(
			allErrs,
	...
	if !infrastructurev1beta1.ValidRegion(c.Spec.Region) {
		allErrs = append(
			allErrs,
	...
	if !reflect.DeepEqual(c.Spec.NetworkSpec.APIServerLB, infrastructurev1beta1.LoadBalancer{}) {
		allErrs = append(
			allErrs,
	...
	return []infrastructurev1beta1.IngressSecurityRuleForNSG{
		{
			IngressSecurityRule: infrastructurev1beta1.IngressSecurityRule{
				...
				Source:     common.String(infrastructurev1beta1.WorkerSubnetDefaultCIDR),
			},
		},
		{
			IngressSecurityRule: infrastructurev1beta1.IngressSecurityRule{
	...
	return []infrastructurev1beta1.EgressSecurityRuleForNSG{
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
				...
				Protocol:        common.String("6"),
				DestinationType: infrastructurev1beta1.EgressSecurityRuleSourceTypeServiceCidrBlock,
			},
		},
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
		...
		},
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
				...
				Destination:     common.String(infrastructurev1beta1.WorkerSubnetDefaultCIDR),
			},
		},
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
	...
	return []infrastructurev1beta1.IngressSecurityRuleForNSG{
		{
			IngressSecurityRule: infrastructurev1beta1.IngressSecurityRule{
				...
				SourceType: infrastructurev1beta1.IngressSecurityRuleSourceTypeCidrBlock,
				Source:     common.String(infrastructurev1beta1.ControlPlaneEndpointSubnetDefaultCIDR),
			},
		},
		{
			IngressSecurityRule: infrastructurev1beta1.IngressSecurityRule{
		...
		},
		{
			IngressSecurityRule: infrastructurev1beta1.IngressSecurityRule{
				...
				SourceType: infrastructurev1beta1.IngressSecurityRuleSourceTypeCidrBlock,
				Source:     common.String(infrastructurev1beta1.ServiceLoadBalancerDefaultCIDR),
			},
		},
	}
}
	...
	return []infrastructurev1beta1.EgressSecurityRuleForNSG{
		...
		},
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
				...
				DestinationType: infrastructurev1beta1.EgressSecurityRuleDestinationTypeCidrBlock,
				Destination:     common.String(infrastructurev1beta1.ControlPlaneEndpointSubnetDefaultCIDR),
			},
		},
		{
			EgressSecurityRule: infrastructurev1beta1.EgressSecurityRule{
