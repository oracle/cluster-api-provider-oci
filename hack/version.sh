...
version::get_version_vars() {
    ...
    # copied from k8s.io/hack/lib/version.sh
    ...
    if GIT_VERSION=$(git describe --tags --abbrev=14 2>/dev/null); then
        ...
        # TODO add this back once we have a release tag
...
# copied from k8s.io/hack/lib/version.sh and modified
...
version::ldflags() {
    ...
    function add_ldflag() {
        ...
        local val=${2}
        ldflags+=(
              "-X 'github.com/oracle/cluster-api-provider-oci/version.${key}=${val}'"
        )
    }
